$(document).ready(function() {
    ...
    $('[data-remove-from-cart]').click(function() {
        ...
        // أعد حساب السعر الإجمالي بعد حذف أحد المّنتجات
        calculateTotalPrice();
    })
    ...
    function calculateTotalPrice() {
        ...
        // أنشئ متغيّرًا جديدَا لحفظ السعر الإجمالي
    ...
    $('#form-checkout select[name="country"]').change(function() {
        ...
        //احلب مدن هذا البلد من المصفوفة
    ...
    $('#form-checkout input[name="payment_method"]').change(function() {
        ...
        if (paymentMethod === 'on_delivery') {
            // إذا كانت عند الاستلام ‘ فعطّل حقول بطاتقة الائتمان
